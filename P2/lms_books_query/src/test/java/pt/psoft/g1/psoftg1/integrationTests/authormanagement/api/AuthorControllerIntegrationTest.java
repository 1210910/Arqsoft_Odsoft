...
public class AuthorControllerIntegrationTest {
    ...
    public void testGetBooksByAuthorNumber_Success() throws Exception {
        // Arrange: Insert an author into the database
        Author author = authorRepository.save(new Author("John Doe", "A famous author", "photo.jpg", null));

        // Act: Perform the GET request to fetch books for this author
...
//        // Act and Assert: Test with no authors in the database
