...
public class BookController {
    ...
    //}
    //
    //@Operation(summary = "Creates a Book, Author and Genre in the same process")
    //@PutMapping(value = "/{isbn}/full")
    //@ResponseStatus(HttpStatus.CREATED)
    //public ResponseEntity<BookView> createFull(@Valid final CreateFullProcessRequest resource,
    //                                           @PathVariable("isbn") final String isbn) {
    //
    //    System.out.println("Entered on the full process of creating a book");
    //
    //    MultipartFile bookFile = resource.getBookPhoto();
    //    MultipartFile authorFile = resource.getAuthorPhoto();
    //
    ...
    //
    //    if (bookFileName != null || authorFileName != null) {
    //        resource.setBookPhotoURI(bookFileName);
    //        resource.setAuthorPhotoURI(authorFileName);
    //    }
    //
    //    Book book;
    //
