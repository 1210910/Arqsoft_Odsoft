...
//        if(!authorRepository.searchByNameName(name).isEmpty()){
//            throw new ConflictException("Author with name " + name + " already exists");
//        }

        Author savedAuthor = authorRepository.save(author);
        System.out.println("Author saved with the following Author Number: " + savedAuthor.getAuthorNumber());
        return savedAuthor;
    }
    ...
    public Author create(AuthorViewAMQP authorViewAMQP) {
        ...
        System.out.println("Author creating with AMQP");

        if(authorRepository.findByAuthorNumber(authorViewAMQP.getAuthorNumber()).isPresent()){
            throw new ConflictException("Author with number " + authorViewAMQP.getAuthorNumber() + " already exists");
        }

        return createAuthor(authorViewAMQP.getName(), authorViewAMQP.getBio(), authorViewAMQP.getPhotoURI());
    }
