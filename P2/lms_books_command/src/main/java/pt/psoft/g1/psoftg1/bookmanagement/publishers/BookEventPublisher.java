...
public class BookEventPublisher {
    ...
    public void sendBookLendingResponse(SagaCreationResponse response) {
        ...
        try {
            ...
            this.template.convertAndSend(direct.getName(), "book.lending.responses", jsonString);

            System.out.println(" [x] Sent '" + jsonString + "'");
        }
        catch( Exception ex ) {
            System.out.println(" [x] Exception sending book lending response: '" + ex.getMessage() + "'");
        }
    }
}
