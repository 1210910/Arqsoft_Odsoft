...
class GenreServiceImplTest {
    ...
    void testFindTopGenreByBooks() {
        ...
        when(genreRepository.findTop5GenreByBookCount(any())).thenReturn(new PageImpl<>(mockList, PageRequest.of(1, 10), mockList.size()));
        ...
        verify(genreRepository, times(1)).findTop5GenreByBookCount(any());
    }
    ...
    void testGetAverageLendings() {
        ...
        assertNotNull(result);
        assertTrue(result.isEmpty());
        verify(genreRepository, times(1)).getAverageLendingsInMonth(any(), any());
    }
    ...
    void testGetLendingsAverageDurationPerMonth_ValidDates() {
        ...
        verify(genreRepository, times(1)).getLendingsAverageDurationPerMonth(any(), any());
    }
