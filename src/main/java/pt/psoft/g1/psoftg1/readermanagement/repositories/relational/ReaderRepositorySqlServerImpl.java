...
import pt.psoft.g1.psoftg1.usermanagement.repositories.relational.UserRepositorySqlServerImpl;
...
public class ReaderRepositorySqlServerImpl implements ReaderRepository {
    ...
    @Autowired
    @Lazy
    public ReaderRepositorySqlServerImpl(ReaderRepositorySqlServer readerRepostorySqlServer, UserRepositorySqlServer userRepositorySqlServer, UserEntityMapper userEntityMapper, ReaderEntityMapper readerEntityMapper, EntityManager entityManager) {
    ...
    public Optional<ReaderDetails> findByUserId(String userId) {
        ...
        return Optional.of(readerEntityMapper.toModel(readerRepostorySqlServer.findByUserId(userIdL).get()));
    }
    ...
    public Page<ReaderDetails> findTopReaders(Pageable pageable) {
        ...
        return readerRepostorySqlServer.findTopReaders(pageable).map(readerEntityMapper::toModel);
    }
